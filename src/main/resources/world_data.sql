...
INSERT INTO  country  ( Code ,  Name ,  Continent ,  Region ,  SurfaceArea ,  IndepYear ,  Population ,  LifeExpectancy ,  GNP ,  GNPOld ,  LocalName ,  GovernmentForm ,  HeadOfState ,  Capital ,  Code2 ) VALUES
	...
	('ARG', 'Argentina', 'South America', 'South America', 2780400.00, 1816, 37032000, 75.1, 340238.00, 323310.00, 'Argentina', 'Federal Republic', 'Fernando de la R?oa', 69, 'AR'),
	...
	('CAF', 'Central African Republic', 'Africa', 'Central Africa', 622984.00, 1960, 3615000, 44.0, 1054.00, 993.00, 'Centrafrique/B?a-Afr??ka', 'Republic', 'Ange-F??lix Patass??', 1889, 'CF'),
	...
	('COD', 'Congo, The Democratic Republic of the', 'Africa', 'Central Africa', 2344858.00, 1960, 51654000, 48.8, 6964.00, 2474.00, 'R??publique D??mocratique du Congo', 'Republic', 'Joseph Kabila', 2298, 'CD'),
	...
	('CPV', 'Cape Verde', 'Africa', 'Western Africa', 4033.00, 1975, 428000, 68.9, 435.00, 420.00, 'Cabo Verde', 'Republic', 'Ant?3nio Mascarenhas Monteiro', 1859, 'CV'),
	...
	('DOM', 'Dominican Republic', 'North America', 'Caribbean', 48511.00, 1844, 8495000, 73.2, 15846.00, 15076.00, 'Rep?oblica Dominicana', 'Republic', 'Hip?3lito Mej?-a Dom?-nguez', 587, 'DO'),
	...
	('HTI', 'Haiti', 'North America', 'Caribbean', 27750.00, 1804, 8222000, 49.2, 3459.00, 3107.00, 'Ha?ˉti/Dayti', 'Republic', 'Jean-Bertrand Aristide', 929, 'HT'),
	...
	('PER', 'Peru', 'South America', 'South America', 1285216.00, 1821, 25662000, 70.0, 64140.00, 65186.00, 'Per?o/Piruw', 'Republic', 'Valentin Paniagua Corazao', 2890, 'PE'),
	...
	('VNM', 'Vietnam', 'Asia', 'Southeast Asia', 331689.00, 1945, 79832000, 69.3, 21929.00, 22834.00, 'Vi?at Nam', 'Socialistic Republic', 'Tr?￠n Duc Luong', 3770, 'VN'),
